...
Podrobné odhady najdete v [TIME_ESTIMATES.md](TIME_ESTIMATES.md).
...
- Nejčastější chyby najdete v [COMMON_MISTAKES.md](COMMON_MISTAKES.md)
...
**A:** Ano! To se nazývá "dual boot". Postupujte podle [Dual Boot scénáře](INSTALLATION-SCENARIOS.md#scenario-1-dual-boot).
...
Porovnání najdete v [COMPARISON_GUIDE.md](COMPARISON_GUIDE.md).
...
- **Laptop hardware:** ✅ Touchpad, webcam, fingerprint - viz [Hardware Phase](phases/HARDWARE.md)
...
Viz [Hardware Phase](phases/HARDWARE.md).
...
Porovnání v [COMPARISON_GUIDE.md](COMPARISON_GUIDE.md).
...
Více v [COMPARISON_GUIDE.md](COMPARISON_GUIDE.md).
...
Viz [Troubleshooting - Network](TROUBLESHOOTING.md#-network-issues).
...
Kompletní checklist v [POST_INSTALL_CHECKLIST.md](POST_INSTALL_CHECKLIST.md).
...
Viz [Backup & Recovery Guide](BACKUP_RECOVERY.md).
...
Viz [Troubleshooting - Boot Issues](TROUBLESHOOTING.md#-boot-issues).
...
- Vytvořte vlastní proceduru podle [GENERATE_PROCEDURE.md](GENERATE_PROCEDURE.md)

...
- `steps/PRE-create-arch-usb.md`
- `steps/PRE-install-windows.md`
- `steps/PRE-format-disk.md`
...
- `DESKTOP_VS_LAPTOP.md` (acceptable - it's a comparison document)

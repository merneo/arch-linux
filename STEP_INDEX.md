...
**Purpose:** Quick reference to find the right steps for your installation

**Before choosing steps:** See [Installation Scenarios](INSTALLATION-SCENARIOS.md) to choose your installation scenario (dual boot, single boot, with/without LUKS).

**Recommended:** Use [Phases](phases/) for organized installation flows instead of individual steps.

---

## Installation Phases

**For organized installation, follow phases in order:**
...
**Remember:** 
- **Recommended:** Follow [phases](phases/) for organized installation flows
- **Alternative:** Use individual [steps](steps/) if you need custom procedure
- Start with preparation steps (`PRE-01`, `PRE-02` if dual boot, `PRE-03` if needed), then proceed with core installation steps

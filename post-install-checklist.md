...
**Quick Links:**
- [Installation Checklist](installation-checklist.md) - Installation progress
- [Troubleshooting](troubleshooting.md) - If you encounter problems
- [Comparison Guide](comparison-guide.md) - Choose desktop environment
...
**Choice:** See [Comparison Guide - Xorg vs Wayland](comparison-guide.md#xorg-vs-wayland)
...
**Choice:** See [Comparison Guide - Desktop Environments](comparison-guide.md#desktop-environments)
...
- [Audio Troubleshooting](troubleshooting.md#audio-issues)
...
**See:** [Hardware Phase](phases/08-hardware.md)
...
**See:** [Security Phase](phases/07-security.md)
...
**See:** [Backup & Recovery Guide](backup-recovery.md)

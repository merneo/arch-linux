...
2.  **[DISK SETUP: Partitioning, LUKS, Btrfs, Mount](../phases/01-DISK_SETUP.md)**
...
3.  **[SYSTEM INSTALL: Base System & Fstab](../phases/02-SYSTEM_INSTALL.md)**
    *   Install the base Arch Linux system using `pacstrap`.
    *   Generate `fstab`.
4.  **[BASIC CONFIGURATION: Locale, User, Sudo](../phases/03-BASIC_CONFIG.md)**
...
10. **[FINALIZE: Exit & Reboot](../phases/09-FINALIZE.md)**
    *   Exit chroot, unmount, and reboot into your new system!

**Post-Installation Choices (after rebooting into your new system):**

*   **[AUR Helper (e.g., yay)](../wiki/03-POST-INSTALLATION.md#aur-helper-eg-yay)**: Highly recommended for easy access to community packages.
*   **[Display Server Configuration](../wiki/03-POST-INSTALLATION.md#display-servers)**: Xorg or Wayland.
*   **[Essential Applications](../wiki/03-POST-INSTALLATION.md#essential-applications)**: Install web browser, office suite, etc.
*   **[Backup Solution (Timeshift)](../wiki/03-POST-INSTALLATION.md#backup-solutions)**: Set up system snapshots.
*   **[Desktop Environment](../wiki/03-POST-INSTALLATION.md#desktop-environments)**: Install GNOME, KDE Plasma, XFCE, or a Window Manager.
...
1.  **[PREPARATION: Create USB & Format Disk](../phases/00-PREPARATION.md)**
    ...
    *   (Optional) Format entire disk for a fresh start.
    *   Boot from USB and connect to the network.
2.  **[DISK SETUP: Partitioning & Mount](../phases/01-DISK_SETUP.md)**
    *   Partition your disk (EFI, Root, Swap).
...
*   **[Backup Solution (Timeshift)](../wiki/03-POST-INSTALLATION.md#backup-solutions)**: Set up system snapshots.
*   **[Desktop Environment](../wiki/03-POST-INSTALLATION.md#desktop-environments)**: Install GNOME, KDE Plasma, XFCE, or a Window Manager.
*   **[Laptop Hardware (Optional)](../phases/08-LAPTOP_HARDWARE.md)**: Configure touchpad, webcam, IR camera, fingerprint reader if applicable.
...
*   **[AUR Helper (e.g., yay)](../wiki/03-POST-INSTALLATION.md#aur-helper-eg-yay)**: Recommended for easy access to community packages.

...
- **[GRUB Bootloader](post-installation.md#grub-bootloader)** - Install GRUB (required)
...
- **Post-Chroot Configuration (After First Boot)**
  - **[AUR Helper (e.g., yay)](post-installation.md#aur-helper-eg-yay)** - Install AUR helper
  - **[Laptop Touchpad](post-installation.md#laptop-touchpad)** - Touchpad configuration (laptops only)
  - **[Laptop Webcam](post-installation.md#laptop-webcam)** - Webcam configuration (laptops only)
  - **[Laptop IR Camera](post-installation.md#laptop-ir-camera)** - IR camera for face recognition (laptops only)
  - **[Laptop Fingerprint](post-installation.md#laptop-fingerprint)** - Fingerprint reader (laptops only)
  - **[SSH Server](post-installation.md#ssh-server)** - SSH server (port 1991, root disabled)
  - **[UFW Firewall](post-installation.md#ufw-firewall)** - UFW firewall configuration
  - **[Fail2ban](post-installation.md#fail2ban)** - Fail2ban SSH protection
- **GPU Drivers**
  - **[NVIDIA GPU Driver Installation](post-installation.md#nvidia-gpu-driver-installation)** - Install NVIDIA proprietary drivers
  - **[AMD GPU Driver Installation](post-installation.md#amd-gpu-driver-installation)** - Install AMD open-source drivers
- **Display Server Configuration**
  - **[Xorg Display Server Configuration](post-installation.md#xorg-display-server-configuration)** - Install and configure Xorg
  - **[Wayland Display Server Configuration](post-installation.md#wayland-display-server-configuration)** - Install and configure Wayland
- **Backup Solutions**
  - **[Timeshift for System Snapshots](post-installation.md#timeshift-for-system-snapshots)** - System backup and restore
- **Terminal Tools**
  - **[w3m Terminal Web Browser](post-installation.md#w3m-terminal-web-browser)** - Text-based web browsing
- **Desktop Environments**
  - **[GNOME Desktop Environment](post-installation.md#gnome-desktop-environment)** - Install GNOME
  - **[KDE Plasma Desktop Environment](post-installation.md#kde-plasma-desktop-environment)** - Install KDE Plasma
  - **[XFCE Desktop Environment](post-installation.md#xfce-desktop-environment)** - Install XFCE
  - **[i3 Window Manager](post-installation.md#i3-window-manager)** - Install i3 Tiling WM
  - **[Hyprland Window Manager](post-installation.md#hyprland-window-manager)** - Install Hyprland Wayland Compositor
...
**Next:** Continue with other configuration steps or [Exit & Reboot](post-installation.md#exit-reboot)
...
- GRUB configured (see [GRUB Bootloader](post-installation.md#grub-bootloader) above)
...
**Prerequisites:**
- Inside chroot environment
- NetworkManager enabled (see [NetworkManager](post-installation.md#networkmanager) above)
...
- Git installed (included in core installation)
- User account created with sudo access (see [User Creation](post-installation.md#user-creation))
...
- AUR Helper installed (see [AUR Helper (e.g., yay)](post-installation.md#aur-helper-eg-yay))
...
**Next:** [UFW Firewall](post-installation.md#ufw-firewall) or [Exit & Reboot](post-installation.md#exit-reboot)
...
**Next:** [Fail2ban](post-installation.md#fail2ban) or [Exit & Reboot](post-installation.md#exit-reboot)
...
- After first boot (not in chroot)
- User account created with sudo access (see [User Creation](post-installation.md#user-creation))
- Network connectivity (see [NetworkManager](post-installation.md#networkmanager))
- Xorg Display Server installed (see [Xorg Display Server Configuration](post-installation.md#xorg-display-server-configuration)) or a Wayland compositor with NVIDIA EGLStreams support.
...
- User account created with sudo access (see [User Creation](post-installation.md#user-creation))
- Network connectivity (see [NetworkManager](post-installation.md#networkmanager))
- Xorg Display Server installed (see [Xorg Display Server Configuration](post-installation.md#xorg-display-server-configuration)) or a Wayland compositor.
- Kernel headers installed (should be present if `linux-headers` was installed during core installation).
...
- After first boot (not in chroot)
- User account created with sudo access (see [User Creation](post-installation.md#user-creation))
- Xorg Display Server installed (see [Xorg Display Server Configuration](post-installation.md#xorg-display-server-configuration))
- Network connectivity (see [NetworkManager](post-installation.md#networkmanager))

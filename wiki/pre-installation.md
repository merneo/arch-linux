...
1. **[Create Arch Linux USB](../steps/pre-create-arch-usb-commands.md)** - Create bootable USB drive (required)
2. **[Install Windows](../steps/pre-install-windows-commands.md)** - Only if dual booting (optional)
3. **[Format Disk](../steps/pre-format-disk-commands.md)** - Only if you want to completely wipe disk (optional)

**Then choose your installation scenario:** See [Installation Scenarios](../installation-scenarios.md) for detailed guidance.

**Recommended:** Follow [Phase 01: Disk Setup](../phases/01-disk-setup.md) for organized disk configuration.

**Or choose individual steps:**

- **[Disk Partitioning](pre-installation.md#disk-partitioning)** - Create disk partitions (single boot or dual boot)
- **[LUKS Encryption](pre-installation.md#luks-encryption)** - Encrypt partitions (optional, for Btrfs + LUKS scenario)
- **[Btrfs Filesystem](pre-installation.md#btrfs-filesystem)** - Create Btrfs with subvolumes (with or without LUKS)
- **[Mount Partitions](pre-installation.md#mount-partitions)** - Mount partitions (non-Btrfs filesystems)
...
**Next:** 
- [LUKS Encryption](pre-installation.md#luks-encryption) - Encrypt partitions (if needed)
- [Btrfs Filesystem](pre-installation.md#btrfs-filesystem) - Create Btrfs filesystem
- [Mount Partitions](pre-installation.md#mount-partitions) - Mount partitions (non-Btrfs)
- [Core Installation](core-installation.md) - If partitions are already mounted
...
**Prerequisites:**
- Disk partitioned (see [Disk Partitioning](pre-installation.md#disk-partitioning) above)
...
**Next:**
- [Btrfs Filesystem](pre-installation.md#btrfs-filesystem) - Create Btrfs filesystem on encrypted partition
- [Mount Partitions](pre-installation.md#mount-partitions) - Mount partitions (non-Btrfs)
- [Core Installation](core-installation.md) - If partitions are already mounted
...
- Root partition ready (encrypted or unencrypted)
  - If encrypted: LUKS container opened (see [LUKS Encryption](pre-installation.md#luks-encryption) above)
...
**Next:**
- [Core Installation](core-installation.md) - Install base system
...
**Back to:** [Home](HOME.md) | **Next:** [Core Installation](core-installation.md)

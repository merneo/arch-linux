...
- SSH server configured (module `ssh-server.md`) - if using SSH
...
- **Fail2ban recommended:** Install fail2ban (see `fail2ban.md`) to prevent SSH brute force attacks
...
**Next:**
- `fail2ban.md` - Install fail2ban to prevent SSH brute force attacks

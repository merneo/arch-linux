...
**Quick Navigation:**
- [Desktop Configurations](installation-scenarios.md#desktop-configurations)
- [Laptop Configurations](installation-scenarios.md#laptop-configurations)
- [Installation Types](installation-scenarios.md#installation-types-by-configuration)
...
2. [Phase 01: Disk Setup](phases/01-disk-setup.md) (choose encryption if desired)
3. [Phase 02: System Install](phases/02-system-install.md)
4. [Phase 03: Basic Config](phases/03-basic-config.md)
5. [Phase 04: Bootloader](phases/04-bootloader.md)
6. [Phase 05: Network](phases/05-network.md)
7. [Phase 09: Finalize](phases/09-finalize.md)
...
**Recommended Phases:**
1. [Phase 00: Preparation](phases/00-preparation.md)
2. [Phase 01: Disk Setup](phases/01-disk-setup.md)
3. [Phase 02: System Install](phases/02-system-install.md)
4. [Phase 03: Basic Config](phases/03-basic-config.md)
5. [Phase 04: Bootloader](phases/04-bootloader.md)
6. [Phase 05: Network](phases/05-network.md)
...
4. [Phase 03: Basic Config](phases/03-basic-config.md)
5. [Phase 04: Bootloader](phases/04-bootloader.md)
6. [Phase 05: Network](phases/05-network.md) - **Include WiFi**
7. [Phase 06: Audio](phases/06-audio.md)
8. [Phase 07: Security](phases/07-security.md)
9. [Phase 08: Hardware](phases/08-hardware.md) - **Laptop hardware**
10. [Phase 09: Finalize](phases/09-finalize.md)
...
2. **[Phase 01: Disk Setup](phases/01-disk-setup.md)** - Partition (dual boot section), choose filesystem
3. **[Phase 02: System Install](phases/02-system-install.md)** - Install base system
4. **[Phase 03: Basic Config](phases/03-basic-config.md)** - Locale, user, root password
...
2. **[Phase 01: Disk Setup](phases/01-disk-setup.md)** - Partition (single boot), LUKS encryption, Btrfs
3. **[Phase 02: System Install](phases/02-system-install.md)** - Install base system
4. **[Phase 03: Basic Config](phases/03-basic-config.md)** - Locale, user, root password
...
**Follow phases in order:**
1. **[Phase 00: Preparation](phases/00-preparation.md)** - Create USB, format disk (optional)
2. **[Phase 01: Disk Setup](phases/01-disk-setup.md)** - Partition (single boot), Btrfs (no LUKS)
3. **[Phase 02: System Install](phases/02-system-install.md)** - Install base system
4. **[Phase 03: Basic Config](phases/03-basic-config.md)** - Locale, user, root password
...
**Next:** Choose your scenario and follow the appropriate [phases](phases/README.md) in order.

**For detailed step-by-step instructions:** See individual [steps](steps/README.md) within each phase.
